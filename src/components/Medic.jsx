    ...
    <div className="flex flex-col">
      ...
      {showShifts && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 m-5">
          {shifts.map((shift) => (
           <div key={shift.id} className="flex justify-between bg-sky-500 rounded-lg shadow-md p-4 border border-gray-600 relative">
           <div>
